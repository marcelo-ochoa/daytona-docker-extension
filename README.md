...
```bash
$ docker extension install mochoa/daytona-docker-extension:0.29.1
Image not available locally, pulling mochoa/daytona-docker-extension:0.29.1...
Extracting metadata and files for the extension "mochoa/daytona-docker-extension:0.29.1"
...
```bash
$ docker extension uninstall mochoa/daytona-docker-extension:0.29.1
