...
func main() {
	...
	flag.StringVar(&socketPath, "socket", "/run/guest-services/daytona-docker-extension.sock", "Unix domain socket to listen on")
	flag.Parse()
...
// ready checks whether daytona is ready or not by querying localhost:9080.
